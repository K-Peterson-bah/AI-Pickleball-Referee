...
def main():
    # Read Video
    input_video_path = './videos/vid1.mp4'
    video_frames = read_video(input_video_path)

    # Create a BallTracker object
    ball_tracker = BallTracker(model_path='./runs/detect/train/weights/best.pt')
    ...
    save_video(output_video_frames, "videos/output_video.avi")
